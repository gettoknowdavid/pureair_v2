...
abstract class AirQualityRemoteDatasource {
  ...
  Future<BaseResponse<AirQualityDto?>> getByGeo({
  ...
  /// bounds.
  @GET('/map/bounds/?')
  Future<BaseResponse<List<StationDto>>> stationsOnMap(
